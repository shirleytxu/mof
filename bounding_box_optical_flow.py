...
def getContourImg(img, maxContours=20):
    ...
    imgWithContourRect = np.zeros_like(img)
...
framesWithOpticalFlow[0].save("bounding_box_optical_flow_result.gif", save_all=True, optimize=False,
